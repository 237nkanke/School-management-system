...
fathername,fathermobile,fathercni FROM students ;";
$result = @mysqli_query($link,$query);
echo '<b>Delete Student</b>';
...
if (array_key_exists("submitstudentinfo",$_POST))
{
    ...
    $query = "SELECT id,firstname,lastname,religion,gender,dob,phone,country,address,joiningdate,status,
    fathername,fathermobile,fathercni FROM students WHERE firstname='$firstname' || lastname='$lastname' ;";
    $result = @mysqli_query($link,$query);
}
?>
     ...
     <table class="table table-striped table-dark">
         ...
         ?>
            <tr class="<?php if(isset($classname)) echo $classname; ?>">
                ...
                <td><a href="delet-process2.php?id=<?php echo $row['id']; ?>">Delete</a></td>
            </tr>
            <?php } ?>
     </table>
