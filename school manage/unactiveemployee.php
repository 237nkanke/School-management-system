<?php
    ...
    $query2 = "SELECT id FROM employee WHERE status='un-active';";
    ...
    FROM employee WHERE status='un-active'";
    ...
    <span class="results">All Student  :</span>
     <table class="table table-striped table-dark">
         ...
         ?>
            ...
            aria-valuemax="100">Total Un-Active Employee <?php echo $count; ?></div>
            </div>
     </table>
