<?php
    ...
    $query2 = "SELECT id FROM students WHERE status='un-active';";
    ...
    fathername,fathermobile,fathercni FROM students WHERE status='un-active'";
    ...
    <span class="results">All Student  :</span>
     <table class="table table-striped table-dark">
         ...
         ?>
            ...
            aria-valuemax="100">Total Un-Active Students <?php echo $count; ?></div>
            </div>
     </table>
