<?php
    ...
    if(array_key_exists("updatestudentinfo", $_POST)){
        ...
        $class = $_POST['class'];
        $query = "UPDATE students SET firstname='$firstname', lastname=' $lastname', religion='$religion',
        gender='$gender', dob=' $phone', phone='$phone', country='$country', address='$address', joiningdate='$joiningdade',
        status='$status', fathername='$fathername', fathermobile='$fathermobile', fathercni='$fathercni', class='$class' WHERE id LIKE '%{$id}%';";
...
<div id="container">
    <form method="Post">
        <span class="headinge" ><b>Student's information : </b></span>
        <div id="student" class="information">
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <select id="inputreligion" name="religion" value="<?php echo $row['religion']?>" required="" class="form-control" id="religion" placeholder="Chose Religion">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input style="width: 540px;" type="text" name="address" value="<?php echo $row['address']?>" required="" class="form-control" id="address" placeholder="Quater">
                </div>
                <div class="form-group col-md-6">
             ...
             <div id="father" class="information">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="fathername" value="<?php echo $row['fathername']?>" required="" class="form-control" id="fathername" placeholder="Fathers Name"> 
                    </div>
                    <div class="form-group col-md-6">
                        <label for="inputfathermobile">Mobile No :</label>
                        <input type="number" name="fathermobile" value="<?php echo $row['fathermobile']?>" required="" class="form-control" id="fathermobile" placeholder="Mobile"> 
                    </div>
                    <div class="form-group col-md-6">
                        <label for="inputfathercni">CNI :</label>
                        <input type="number" name="fathercni" value="<?php echo $row['fathercni']?>" required="" class="form-control" id="fathercni" placeholder="0000-000000-0"> 
                    </div>
                </div>
             </div>
            </div>
        ...
        <div style="margin-top: 20px;">
            <fieldset class="form-group">
                <a href="allstudents.php" style="margin-left: 43%;" class="btn btn-primary" 
                >Go back</a>
            </fieldset>
        </div>
    </form>
