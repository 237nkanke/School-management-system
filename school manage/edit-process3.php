<?php
    ...
    if(array_key_exists("updatestudentinfo", $_POST)){
        ...
        status='$status',  $anmision='admisionnum' WHERE id LIKE '%{$id}%';";
...
<div id="container">
    <form method="Post">
        <span class="headinge" ><b>Employee's information : </b></span>
        <div id="student" class="information">
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="admisionnum" value="<?php echo $row['admisionnum']?>" required="" class="form-control" id="admisionnum" placeholder="Last Name">
                </div>
