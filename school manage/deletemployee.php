...
include'header.php';
include'footer.php';
$query = "SELECT id,firstname,lastname,admisionnum,gender,dob,phone,country,adress,joiningdate,status FROM employee ;";
$result = @mysqli_query($link,$query);
echo '<b>Delete Employee</b>';
...
if (array_key_exists("submitstudentinfo",$_POST))
{
    ...
    $query = "SELECT id,firstname,lastname,admisionnum,gender,dob,phone,country,address,joiningdate,status FROM employee WHERE firstname='$firstname' || lastname='$lastname' ;";
    $result = @mysqli_query($link,$query);
}
?>
 ...
 <div id="table">
     ...
     <table class="table table-striped table-dark">
         <tr>
             ...
             <th class="nka" scope='col'>Admision Num</th>
         ...
         ?>
            <tr class="<?php if(isset($classname)) echo $classname; ?>">
                ...
                <td><a href="delet-process3.php?id=<?php echo $row['id']; ?>">Delete</a></td>
            </tr>
            <?php } ?>
     </table>
