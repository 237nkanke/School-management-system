...
$query = "SELECT id,firstname,lastname,admisionnum,gender,dob,phone,country,adress,joiningdate,status
 FROM employee WHERE firstname='$firstname' || lastname='$lastname' || gender='$gender' ORDER BY firstname asc ";
$result = mysqli_query($link,$query);
}
else{
    $query = "SELECT id,firstname,lastname,admisionnum,gender,dob,phone,country,adress,joiningdate,status
 FROM employee  ORDER BY firstname DESC;";
$result = mysqli_query($link,$query);
}
?>
...
<div id="table">
    ...
    <form action="allfaculty.php" method="Post">
            <div class="form-row">
            ...
            <span class="results">All Employee's information:</span>
         ...
         <tr class="<?php if(isset($classname)) echo $classname; ?>">
                ...
                <td><a href="individualemployeerecord.php?id=<?php echo $row['id']; ?>"><?php echo $row['firstname']?></a></td>
            ...
            aria-valuemax="100">Total  Employee <?php echo $count; ?></div>
            </div>
     </table>
